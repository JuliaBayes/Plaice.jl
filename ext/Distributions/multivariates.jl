...
Plaice.Plaice.from_unconstrained_vec(::SIMPLEX_MULTIVARIATES) =
    Plaice.inverse(Plaice.SimplexBijector())
Plaice.Plaice.to_unconstrained_vec(::SIMPLEX_MULTIVARIATES) = Plaice.SimplexBijector()
Plaice.Plaice.unconstrained_vec_length(d::SIMPLEX_MULTIVARIATES) = length(d) - 1
